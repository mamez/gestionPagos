...
public class LeerParametrosProperties {
    ...
    public String getLeerParametrosPropertiesDesencriptado(String parametro) {
        ...
        try {
            ...
            log.error("No se encontra el archivo properties, verifique el nombre y la ubicación - " + e + " - " + e.getMessage() + " - " + LeerParametrosProperties.class.getName());
    ...
    public String getLeerParametrosProperties(String parametro) {
        ...
        try {
            ...
            log.error("No se pudo cerrar el input, el cual lee los parametros de conexiÃ³n del .properties - " + e + " - " + e.getMessage() + " - " + LeerParametrosProperties.class.getName());
